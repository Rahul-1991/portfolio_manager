...
function ExternalAppScheme(props) {
    return (
        <div>
          {props.isVisible && <div className="mf-schemes">
            ...
            <div className="mf-scheme-header">
              <p className="components-text-heading">APPLICATION</p>
            ...
            {props.component.investments.map(scheme => {
              return <div className="mf-scheme">
                ...
                <div style={{ flex: 1 }}>
                  <p className="components-text">{scheme.roi}%</p>
                </div>
                <div style={{ flex: 1 }}>
...
export default ExternalAppScheme